...
Loops were firstly called using [Mustache](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-020-02167-0). Afterwards, a union of significantly called loops in each condition (M1, M4 and NTC) was used for differential analysis using a modified DESeq2 approach via [HiCDCPlus](https://www.nature.com/articles/s41467-021-23749-x). Knockdown samples (M1 and M4) were pooled together. 
